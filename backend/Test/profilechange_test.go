...
// var (
// 	repEmail       = "handlertest@" + uuid.NewV4().String() + ".com"
// 	exampleUpdates = []structs.User{, {
...
// 	}, {FirstName: "Update", LastName: "Update", NickName: "Update", Email: repEmail, DateOfBirth: "06-08-2002", AboutMe: "Update", Avatar: "Update", IsPublic: 1}}
// )
...
func TestProfileUpdate(t *testing.T) {
	...
	t.Run("Test with taken email", func(t *testing.T) {
		...
		handlerEmail := "handlertest@" + uuid.NewV4().String() + ".com"
		repEmail := "new@" + uuid.NewV4().String() + ".com"
		originalUser := structs.User{FirstName: "FirstTest", LastName: "LastTest", NickName: "NickTest", Email: repEmail, Password: "TestPass",
		DateOfBirth: "0001-01-01T00:00:00Z", AboutMe: "Test about me section", Avatar: "testPath", CreatedAt: "", UserId: "-", SessionId: "-",
		IsLoggedIn: 0, IsPublic: 0, NumFollowers: 0, NumFollowing: 0, NumPosts: 0,}
