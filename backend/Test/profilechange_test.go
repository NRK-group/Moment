...
func TestProfileUpdate(t *testing.T) {
	t.Run("update with valid user", func(t *testing.T) {
		...
		loginUser := structs.User{Email: handlerEmail, Password: "TestPass"}
		// Marhsal the struct to a slice of bytes
		...
		Env.Login(wr, r)
		updateUser := structs.User{FirstName: "Update", LastName: "Update", NickName: "Update", Email: strings.ToLower(repEmail), DateOfBirth: "06-08-2002", AboutMe: "Update", Avatar: "Update", IsPublic: 1}
